...
class StoryNK:
    ...
    <div class="report">
        ...
        {self._html_llm_diagnosis_section(diagnosis, rel(str(Path(__file__).resolve().parents[2] / "icons" / "OpenAI-black-monoblossom.png")))}
    ...
    def _html_llm_diagnosis_section(self, diagnosis: Optional[Dict[str, Any]], icon_src: str) -> str:
        if not diagnosis:
            return """
            <h2 id="LLM"><img src="{self._html(icon_src)}" style="width:100px; padding:5px;"> LLM Revision Diagnosis</h2>
