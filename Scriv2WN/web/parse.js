...
var Manuscript = /** @class */ (function () {
     ...
     */
    function Manuscript(sourceURL, script) {
        this.sourceURL = sourceURL;
        this.script = script;
    }
    Manuscript.initialize = function (sourceURL) {
        return __awaiter(this, void 0, void 0, function () {
            var response, data;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(sourceURL)];
                    case 1:
                        response = _a.sent();
                        if (!response.ok) {
                    ...
                    case 2:
                        data = _a.sent();
                        return [2 /*return*/, new Manuscript(sourceURL, data)];
                }
            });
        });
    };
